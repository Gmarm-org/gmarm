...
export interface Client {
  ...
  estado?: 'ACTIVO' | 'FALTAN_DOCUMENTOS' | 'PENDIENTE_DOCUMENTOS' | 'EN_PROCESO' | 'BLOQUEADO' | 'LISTO_IMPORTACION' | 'EN_PROCESO_VALIDACION' | 'EN_CURSO_IMPORTACION' | 'SERIE_ASIGNADA' | 'INACTIVO' | 'PENDIENTE_ASIGNACION_CLIENTE' | 'INHABILITADO_COMPRA' | 'RECHAZADO' | 'CANCELADO' | 'APROBADO' | 'CONTRATO_ENVIADO' | 'CONTRATO_FIRMADO' | 'PROCESO_COMPLETADO';
