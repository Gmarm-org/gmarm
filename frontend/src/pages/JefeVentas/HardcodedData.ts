...
export const mockImportGroups: ImportGroup[] = [
  {
    ...
    fechaFin: '2024-03-31',
    cuposDisponibles: { civil: 15, militar: 0, empresa: 0, deportista: 0 },
    cuposUtilizados: { civil: 10, militar: 0, empresa: 0, deportista: 0 },
    licenciasAsignadas: 3,
    clientesAsignados: 10
  },
  {
    id: 2,
    codigo: 'IMP-2024-002',
    nombre: 'Importación Militar Q1 2024',
    descripcion: 'Grupo de importación militar para el primer trimestre',
    estado: 'ACTIVO',
    fechaCreacion: '2024-01-15',
    fechaInicio: '2024-01-15',
    fechaFin: '2024-03-31',
    cuposDisponibles: { civil: 0, militar: 30, empresa: 0, deportista: 0 },
    cuposUtilizados: { civil: 0, militar: 20, empresa: 0, deportista: 0 },
    licenciasAsignadas: 2,
    clientesAsignados: 20
  },
  {
    id: 3,
    codigo: 'IMP-2024-003',
    nombre: 'Importación Empresarial Q1 2024',
    descripcion: 'Grupo de importación para empresas de seguridad',
    estado: 'PENDIENTE',
    fechaCreacion: '2024-02-01',
    fechaInicio: '2024-02-01',
    fechaFin: '2024-04-30',
    cuposDisponibles: { civil: 0, militar: 0, empresa: 50, deportista: 0 },
  ...
  },
  {
    id: 4,
    codigo: 'IMP-2024-004',
    nombre: 'Importación Deportista Q1 2024',
    descripcion: 'Grupo de importación para deportistas',
    estado: 'ACTIVO',
    fechaCreacion: '2024-01-10',
    fechaInicio: '2024-01-10',
    fechaFin: '2024-03-31',
    cuposDisponibles: { civil: 0, militar: 0, empresa: 0, deportista: 100 },
    cuposUtilizados: { civil: 0, militar: 0, empresa: 0, deportista: 30 },
    licenciasAsignadas: 1,
