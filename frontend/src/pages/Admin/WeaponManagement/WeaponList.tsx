...
const WeaponList: React.FC = () => {
  ...
  const loadCategories = async () => {
    try {
      ...
      console.error('❌ WeaponList - Error ca30 muinrgando categorías:', error);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Header 
        ...
        subtitle="Administra el catálogo de armas del sistema"
        showBackButton={true}
          ...
          filters={
            <div className="flex items-center space-x-4">
              <label className="flex items-center space-x-2">
                ...
                />
                <span className="text-sm text-gray-700">Solo armas activas</span>
              </label>
              {!showOnlyActive && (
