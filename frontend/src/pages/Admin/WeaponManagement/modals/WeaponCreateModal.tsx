...
const WeaponCreateModal: React.FC<WeaponCreateModalProps> = ({
  categories,
  isOpen,
  onClose,
  onSave
  ...
  const handleSave = async () => {
    ...
    if (!createForm.calibre.trim()) {
      alert('El calibre es obligatorio');
      return;
    }
    if (createForm.precioReferencia <= 0) {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-6 max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold text-gray-900">Crear Nueva Arma</h2>
          <button
            onClick={handleClose}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  step="0.01"
                  min="0"
                  value={createForm.precioReferencia}
              ...
              <div className="flex items-center space-x-4">
                <label className="flex items-center">
                  <input
                    ...
                    name="estado"
                    value="true"
                    checked={createForm.estado === true}
                ...
                <label className="flex items-center">
                  <input
                    ...
                    name="estado"
                    value="false"
                    checked={createForm.estado === false}
            ...
            <div>
              ...
              <input
                type="url"
                value={createForm.urlProducto}
                onChange={(e) => handleInputChange('urlProducto', e.target.value)}
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
          ...
          <div className="space-y-4">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              ...
              <div className="text-sm text-blue-800 space-y-1">
                <p><strong>ID:</strong> Se asignará automáticamente</p>
                <p><strong>Fecha de Creación:</strong> Se establecerá automáticamente</p>
                <p><strong>Última Modificación:</strong> Se establecerá automáticamente</p>
              </div>
            </div>
          </div>
        </div>
...
export default WeaponCreateModal;
