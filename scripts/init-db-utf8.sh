#!/bin/bash
# =====================================================
# Script para inicializar la base de datos con codificación UTF-8 (Linux)
# =====================================================

echo "🔄 Inicializando base de datos con codificación UTF-8..."
...
# En Linux, usar cat con codificación UTF-8
cat "datos/00_gmarm_completo.sql" | docker exec -i $CONTAINER_NAME psql -U $DB_USER -d $DB_NAME

if [ $? -eq 0 ]; then
    echo "✅ Base de datos inicializada correctamente con codificación UTF-8"
